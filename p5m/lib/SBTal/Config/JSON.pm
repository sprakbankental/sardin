...
SBTal::Config::JSON - [One line description of module's purpose here]

=head1 VERSION

This document describes SBTal::Config::JSON v0.1.0

=head1 SYNOPSIS

use SBTal::Config::JSON;
...
=head2 C<< my $o = ($obj|SBTal::Config::JSON)->new(%PARAMS); >>
...
SBTal::Config::JSON requires no configuration files or environment variables.
