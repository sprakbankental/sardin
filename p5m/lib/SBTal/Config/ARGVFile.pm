...
#
# SBTal::Config::ARGVFile->new(%params)
...
SBTal::Config::ARGVFile - [One line description of module's purpose here]

=head1 VERSION

This document describes SBTal::Config::ARGVFile v0.1.0

=head1 SYNOPSIS

use SBTal::Config::ARGVFile;
...
=head2 C<< my $o = ($obj|SBTal::Config::ARGVFile)->new(%PARAMS); >>
...
SBTal::Config::ARGVFile requires no configuration files or environment variables.
