package SBTal::Config::DataDumper;
...
SBTal::Config::DataDumper - [One line description of module's purpose here]

=head1 VERSION

This document describes SBTal::Config::DataDumper v0.1.0

=head1 SYNOPSIS

use SBTal::Config::DataDumper;
...
=head2 C<< my $o = ($obj|SBTal::Config::DataDumper)->new(%PARAMS); >>
...
SBTal::Config::DataDumper requires no configuration files or environment variables.
