...
#
# SBTal::Config::Storable->new(%params)
...
SBTal::Config::Storable - [One line description of module's purpose here]

=head1 VERSION

This document describes SBTal::Config::Storable v0.1.0

=head1 SYNOPSIS

use SBTal::Config::Storable;
...
=head2 C<< my $o = ($obj|SBTal::Config::Storable)->new(%PARAMS); >>
...
SBTal::Config::Storable requires no configuration files or environment variables.
