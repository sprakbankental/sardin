...
SBTal::Config::MQTT - [One line description of module's purpose here]

=head1 VERSION

This document describes SBTal::Config::MQTT v0.1.0

=head1 SYNOPSIS

use SBTal::Config::MQTT;
...
=head2 C<< my $o = ($obj|SBTal::Config::MQTT)->new(%PARAMS); >>
...
SBTal::Config::MQTT requires no configuration files or environment variables.
