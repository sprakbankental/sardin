...
#
# SBTal::Config::Sereal->new(%params)
...
SBTal::Config::Sereal - [One line description of module's purpose here]

=head1 VERSION

This document describes SBTal::Config::Sereal v0.1.0

=head1 SYNOPSIS

use SBTal::Config::Sereal;
...
=head2 C<< my $o = ($obj|SBTal::Config::Sereal)->new(%PARAMS); >>
...
SBTal::Config::Sereal requires no configuration files or environment variables.
